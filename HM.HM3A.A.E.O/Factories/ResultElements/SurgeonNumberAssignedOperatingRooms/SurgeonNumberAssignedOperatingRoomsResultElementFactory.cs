namespace HM.HM3A.A.E.O.Factories.ResultElements.SurgeonNumberAssignedOperatingRooms
{
    using System;

    using log4net;

    using HM.HM3A.A.E.O.Classes.ResultElements.SurgeonNumberAssignedOperatingRooms;
