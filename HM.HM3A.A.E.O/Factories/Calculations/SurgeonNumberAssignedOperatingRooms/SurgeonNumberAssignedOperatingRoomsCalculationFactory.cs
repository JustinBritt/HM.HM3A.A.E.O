namespace HM.HM3A.A.E.O.Factories.Calculations.SurgeonNumberAssignedOperatingRooms
{
    using System;

    using log4net;

    using HM.HM3A.A.E.O.Classes.Calculations.SurgeonNumberAssignedOperatingRooms;
