namespace HM.HM3A.A.E.O.Factories.Results.SurgicalSpecialtyNumberAssignedOperatingRooms
{
    using System;
    ...
    using HM.HM3A.A.E.O.Classes.Results.SurgicalSpecialtyNumberAssignedOperatingRooms;
