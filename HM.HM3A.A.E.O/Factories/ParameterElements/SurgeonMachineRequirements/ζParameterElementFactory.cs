namespace HM.HM3A.A.E.O.Factories.ParameterElements.SurgeonMachineRequirements
{
    using System;
    ...
    using HM.HM3A.A.E.O.Classes.ParameterElements.SurgeonMachineRequirements;
